...
- [ ] **P3-11** — [Investigate rare steal-path mutual-exclusion flake under load](tasks/P3-11-lock-steal-mutual-exclusion-flake.md) — the P3-07 stale-lock-steal exclusion test observed `maxActive === 2` once on a loaded CI runner (passed on re-run, 0/15 locally); determine real race vs. filesystem semantics vs. test brittleness and make it deterministic; surfaced on P3-08 CI

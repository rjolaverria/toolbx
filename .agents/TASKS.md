...
- [ ] **P3-10** — [Align the credential-lock domain with the token-store key namespace](tasks/P3-10-credential-lock-domain.md) — the P3-08 lock is config-dir-scoped while keychain records are machine-global, so commands run against different `-c` configs do not serialize on the same credential; surfaced during P3-08 review

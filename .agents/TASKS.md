...
- [ ] **P3-08** — [Per-server-name serialization of OAuth registration](tasks/P3-08-oauth-registration-serialization.md) — serialize concurrent same-name `add-http --auth oauth` so the winner's token/config can't be clobbered; surfaced during P3-07 review

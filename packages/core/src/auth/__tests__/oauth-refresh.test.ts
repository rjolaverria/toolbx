...
describe('runOAuthRefresh', () => {
  it('refreshes the stored token without opening a browser and persists the rotated pair', async () => {
    ...
    // A real refresh stamps a new obtainedAt, distinct from the seeded one.
